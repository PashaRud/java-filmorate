...
class FilmControllerTest {
    ...
    void updateFilmNotWithoutIdTest() throws Exception {
        mockMvc.perform((put("/films"))
                ...
                .andExpect(result -> assertEquals("Невозможно обновить фильм. Такого фильма в списке не " +
                                "существует.",
    ...
    void createFilmOldReleaseDateTest() throws Exception {
        mockMvc.perform((post("/films"))
                        ...
                        .content("{\n" +
                                ...
                                "}"))
                .andExpect(result -> assertEquals("Некорректная дата выхода картины. Первое кино было выпущено 28.12.1895",
                        result.getResolvedException().getMessage()))
                .andExpect(status().isInternalServerError());
    }
